package com.example.locadatabase;
...
import com.example.locadatabase.adapter.NoteAdapter;
import com.example.locadatabase.db.NoteHelper;
import com.example.locadatabase.model.Note;
import com.example.locadatabase.util.MappingHelper;
    ...
    private static class LoadNoteAsync {
        ...
        void execute() {
            ...
            executor.execute(() -> {
                ...
                ArrayList<Note> students = MappingHelper.mapCursorToArrayList(studentsCursor);
                noteHelper.close();
