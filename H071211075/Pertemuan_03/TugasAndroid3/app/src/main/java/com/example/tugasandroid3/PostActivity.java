    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(upImage.getDrawable().getConstantState() == getResources().getDrawable(R.drawable.img).getConstantState()){
                    Toast.makeText(PostActivity.this, "Upload Image First", Toast.LENGTH_SHORT).show();
                }
                if(TextUtils.isEmpty(edCaption.getText().toString())){
                    edCaption.setError("Required");
                }
                if(upImage.getDrawable().getConstantState() != getResources().getDrawable(R.drawable.img).getConstantState()
                        && !TextUtils.isEmpty(edCaption.getText().toString())){
