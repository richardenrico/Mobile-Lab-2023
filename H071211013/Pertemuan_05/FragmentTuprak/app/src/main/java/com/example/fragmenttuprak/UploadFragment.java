...
public class UploadFragment extends Fragment {
    ...
    private PostArrayList.OnPostAddedListener onPostAddedListener;

    public void setOnPostAddedListener(MainActivity listener) {
    ...
    private void uploadPost() {
        if (imageUri != null && onPostAddedListener != null) {
            ...
            Post post = new Post(imageUri, postCaption.getText().toString());
